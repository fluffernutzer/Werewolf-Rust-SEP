    ...
    pub fn priester_wirft(
        ...
        if let Some(ziel) = target_name {
            ...
            if self.players[priester_index].name == ziel {
                ...
                return Err(
                    "Der Priester kann sich nicht selbst mit heiligen Wasser bewerfen.".into(),
                );
            }
            ...
            if ziel_team == Team::TeamWerwolf {
                log::info!(
                    "(NACHT) Priester wirft heiliges Wasser auf {} ! Es ist ein Werwolf!",
                    ziel
                );
                ...
                log::info!(
                    "(NACHT) Priester wirft heiliges Wasser auf {} ! Es ist leider kein Werwolf; der Priester stirbt.",
                    ziel
                );
